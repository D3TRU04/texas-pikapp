...
export function Hero() {
  return (
    <section className="relative bg-cream-100 flex flex-col md:flex-row items-center justify-between min-h-[80vh] mt-12 mb-20 md:mt-24 md:mb-32 py-24 px-6 md:px-32 gap-2 md:gap-4 overflow-hidden">
      {/* Top Wave */}
      ...
      {/* Left: Text */}
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left gap-6 relative z-20">
        <h1 className="text-4xl md:text-6xl text-burnt-orange-500 leading-tight tracking-tight">
          Welcome to <br />Texas Pi Kapp!
        </h1>
        <p className="text-lg md:text-xl text-charcoal-900 max-w-lg">
        ...
        <Link
          href="/recruitment"
          className="inline-flex items-center px-8 py-4 bg-burnt-orange-500 text-cream-100 rounded-lg transition-colors hover:bg-burnt-orange-600 text-lg shadow"
        >
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center relative z-20">
        <img
          src="/welcome-pic.png"
      ...
      {/* Gray Grid Overlay - behind everything */}
